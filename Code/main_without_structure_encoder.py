...
# ============== 消融实验: Without Structure Encoder ==============
print("=" * 60)
print("消融实验: Without Structure Encoder (仅 Sequence Encoder)")
print("=" * 60)
...
n_epochs = 100
best_score = -1.0
best_model_path = "best_model_without_structure_encoder.pth"
...
# 最终评估
print("\n" + "=" * 60)
print("最佳模型最终评估结果 (Without Structure Encoder)")
print("=" * 60)
