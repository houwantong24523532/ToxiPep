...
# ============== 消融实验: Without Sequence Encoder ==============
print("=" * 60)
print("消融实验: Without Sequence Encoder (仅 Structure Encoder)")
print("=" * 60)
...
n_epochs = 100
best_score = -1.0
best_model_path = "best_model_without_sequence_encoder.pth"
...
# 最终评估
print("\n" + "=" * 60)
print("最佳模型最终评估结果 (Without Sequence Encoder)")
print("=" * 60)
