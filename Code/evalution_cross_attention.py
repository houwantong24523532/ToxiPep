...
print("=" * 60)
print("对比评估: Cross Attention 特征融合")
print("=" * 60)
...
checkpoint = torch.load("best_model_cross_attention.pth", map_location=device, weights_only=False)
...
save_metrics_to_csv(metrics, "test_metrics_cross_attention.csv")
