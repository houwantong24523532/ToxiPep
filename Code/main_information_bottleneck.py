...
# ============== 对比实验: Information Bottleneck ==============
print("=" * 60)
print("对比实验: Information Bottleneck (DVIB) 特征融合")
print("=" * 60)
...
n_epochs = 100
best_score = -1.0
best_model_path = "best_model_information_bottleneck.pth"
...
print("\n" + "=" * 60)
print("最佳模型最终评估结果 (Information Bottleneck)")
print("=" * 60)
